...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		MeterAdressChoices = []
		self.MeterAdress = wx.ComboBox( self.m_panel511, wx.ID_ANY, u"GPIB0::22::INSTR", wx.DefaultPosition, wx.DefaultSize, MeterAdressChoices, 0 )
		gbSizer311.Add( self.MeterAdress, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		SAdressChoices = []
		self.SAdress = wx.ComboBox( self.m_panel511, wx.ID_ANY, u"GPIB0::2::INSTR", wx.DefaultPosition, wx.DefaultSize, SAdressChoices, 0 )
		...
		self.m_staticText13 = wx.StaticText( self.m_panel511, wx.ID_ANY, u"Stable source", wx.DefaultPosition, wx.DefaultSize, 0 )
